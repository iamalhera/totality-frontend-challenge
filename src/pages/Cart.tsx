      ...
      {cart.length > 0 && (
        <div className='flex flex-col items-center'>
          ...
          <div className='mt-3 font-semibold'>
           Booking Properties: <>{cart?.length}</> | Total Booked Amount : $<>{amount}</>  
          </div>
          <Link
            to="/checkout" 
            className="mt-4 max-w-72 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full block"
