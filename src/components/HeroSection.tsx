  ...
  <div className="relative isolate px-6 lg:px-8">
    <div className="mx-auto max-w-2xl py-18 sm:py-24 lg:py-24">
      <div className="hidden sm:mb-8 sm:flex sm:justify-center">
        ...
        Announcing Our Next Batch of Exotic Properties for Unforgettable Stays! <a href="#" className="font-semibold text-blue-600"><span className="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link to="/property-listing" className="rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:text-blue-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-100">Explore Properties</Link>
